...
def prediction_temperature(punkt: str, spisok: list) -> dict:
    model = joblib.load('C:\П\Tg_weather_bot/trained_random_forest_regressor.joblib')

    dict_day_and_month = {}

    for spis in spisok:

        year, month, day, day_time, wind_speed, wind_direction, permission, vlaznost, osadki, pogoda = spis[0], spis[1], \
            spis[2], spis[3], spis[4], spis[5], spis[6], spis[7], spis[8], spis[9]
